                ...
                <div class="col">
                    <table class="table text-center border border-cyan">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="3">
                                    <a href="#" class="btn btn-xs btn-flat btn-primary bg-gradient-primary" type="submit" data-toggle="modal" data-target="#ModalCreate">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('reportAlert')}}" target="_blank" method="GET">
                                ...
                                <input class="btn-xs btn-flat btn-primary bg-gradient-primary" type="submit" value="ver registros"> <span class="iconify" data-icon="bi:clipboard2-data"></span>
